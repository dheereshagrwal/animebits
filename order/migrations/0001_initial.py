    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Cancelled', 'Cancelled'), ('Delivered', 'Delivered'), ('In Return', 'In Return'), ('Refunded', 'Refunded'), ('Completed', 'Completed')], default='New', max_length=20)),
